      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            {onBack && (
              <Button variant="ghost" onClick={onBack} className="mr-4 transition-all duration-300 hover:scale-105 motion-reduce:hover:scale-100">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-sm text-muted-foreground">Monitoring: {selectedChild}</div>
          </div>
        </div>
